...
describe "User pages" do
 ...
 describe "profile page" do
	...
	let!(:m1) { FactoryGirl.create(:game, user: user, name: "Foo", location: "US", console: "bar") }
    let!(:m2) { FactoryGirl.create(:game, user: user, name: "bar", location: "US", console: "foo") }
	...
	describe "games" do
      ...
      it { should have_content(user.games.count) }
    end
